  ...
  return (
    <div className='flex flex-col gap-10 px-4 py-10 '>
      <div className='flex flex-col gap-4 md:pr-44'>
        <h1 className='text-[#111118] text-1xl font-bold font-sans leading-tight md:text-4xl md:font-black md:leading-tight'>How it works</h1>
        <p className='text-[#111118] text-base font-normal leading-normal md:text-lg'>
      ...
      <div className='grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3'>
        ...
        <div className='flex flex-col gap-3 pb-3'>
          ...
          ></div>
          <div>
            <p className='text-[#111118] text-base font-medium leading-normal font-sans'>Get updates</p>
            <p className='text-[#636388] text-sm font-normal leading-normal'>
