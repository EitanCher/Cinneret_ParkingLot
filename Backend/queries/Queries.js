module.exports = {
  ...
  insertUser: `INSERT INTO "ParkingLot_DB"."Users" ("persId", "FirstName", "LastName", "Phone", "Email", "SubscriptStart", "SubscriptEnd", "Active")
                  VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *;`,

  updateUser: `UPDATE "ParkingLot_DB"."Users"
  ...
  insertCar: `INSERT INTO "ParkingLot_DB"."Cars" ("RegistrationID", "Model", "OwnerID")
                  VALUES ($1, $2, $3) RETURNING *;`,

  updateCar: `UPDATE "ParkingLot_DB"."Cars"
  ...
  insertParkingLog: `INSERT INTO "ParkingLot_DB"."ParkingLog" ("CarID", "SlotID", "Entrance", "Exit", "ParkingStart", "ParkingEnd", "SavingStart", "SavingEnd", "Violation")
                        VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *;`,

  updateParkingLog: `UPDATE "ParkingLot_DB"."ParkingLog"
  ...
  insertArea: `INSERT INTO "ParkingLot_DB"."Areas" ("AreaName")
                  VALUES ($1) RETURNING *;`,

  updateArea: `UPDATE "ParkingLot_DB"."Areas"
                  SET "AreaName" = $1
  ...
  insertSlotSize: `INSERT INTO "ParkingLot_DB"."SlotSizes" ("Size")
                      VALUES ($1) RETURNING *;`,

  updateSlotSize: `UPDATE "ParkingLot_DB"."SlotSizes"
                      SET "Size" = $1
  ...
  insertBorder: `INSERT INTO "ParkingLot_DB"."Borders" ("Violated")
                    VALUES ($1) RETURNING *;`,

  updateBorder: `UPDATE "ParkingLot_DB"."Borders"
                    SET "Violated" = $1
  ...
  insertSlot: `INSERT INTO "ParkingLot_DB"."Slots" ("Busy", "Area", "SavedFor", "TakenBy", "BorderLeft", "BorderRigth", "Size", "Active", "Fault")
                  VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *;`,

  updateSlot: `UPDATE "ParkingLot_DB"."Slots"
